...
void setup()
{
  ...
  backgroundMusic = new SoundFile(this, "Bop Walker - Freedom Trail Studio.mp3"); //This song is taken from the YouTube song Library, the channel is https://www.youtube.com/channel/UCx6kpgiQkDkN1UnK5GaATGw, the owner reserves all rights to the song.
